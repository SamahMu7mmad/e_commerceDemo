...
public class P03_homePage {
    ...
    public List<WebElement> skuResults() {
        List<WebElement> skuResult = Hooks.driver.findElements(By.xpath("//div[@class='sku']"));
        return skuResult;
    }
    public List<WebElement> searchResults() {
        List<WebElement> searchRes = Hooks.driver.findElements(By.className("product-title"));
        return searchRes;
    }
